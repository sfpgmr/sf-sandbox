var app = (function () {
    ...
    function create_then_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			div1.innerHTML = `<header class="hero-body"><h1 class="title">コンテンツと類似するコンテンツをdoc2vecで求める</h1> 
    <div class="block"><p>このリストは、sfpgmr.netサイト内のコンテンツ同士の類似度をdoc2vecで求めた結果です。1つのコンテンツに対して類似度を求め高い順から10個選択するようにしています。</p> 
      <p>以下のステップで作成しています。</p></div></header>`;

    			t5 = space();
    			nav = element("nav");
    			div6 = element("div");
    			div2 = element("div");
    			div2.innerHTML = `<p class="subtitle">Page</p>`;
    			t7 = space();
    			div4 = element("div");
    			div3 = element("div");
    			input = element("input");
        ...
        <th class="svelte-cncxa3">類似度(0.0-1.0)</th></tr>`;
    			...
    			tfoot.innerHTML = `<tr><th class="svelte-cncxa3">コンテンツ</th> 
      <th class="svelte-cncxa3">類似コンテンツ</th> 
      <th class="svelte-cncxa3">類似度(0.0-1.0)</th></tr>`;
    			...
    			attr(div10, "class", "table-container");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*maxPage*/ 4) set_data(t10, /*maxPage*/ ctx[2]);
    ...
    // (98:2) {#each siteInfoFragments as content }
